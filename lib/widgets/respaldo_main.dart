          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => ChatPage()), // Navega al chat
              );
            },
          ),
          Switch(
        ...
        builder: (context, snapshot) {
          ...
          return GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: kIsWeb ? 4 : 2, // Más columnas en web
              crossAxisSpacing: 8.0,
              mainAxisSpacing: 8.0,
              childAspectRatio: 1.0, // Ajusta la proporción de los elementos
            ),
            itemCount: productDocs.length,
            itemBuilder: (context, index) {
              final product = productDocs[index].data() as Map<String, dynamic>;
                        ...
                        child: Container(
                          ...
                          child: product['imageUrl'] != null
                              ? Image.network(
                                  ...
                                  fit: BoxFit
                                      .contain, // Contiene la imagen dentro
